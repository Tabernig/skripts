...
with rasterio.open("D:\_Programmieren\VU_Automatisierung_Daten\Daten\session6\s2_img_exercise\T32TPT_20200913T101629_SCL_20m.tif","r") as obj:
    array = obj.read(1)
    #Values to remove from Mask
    for value in [0,1,2,3,8,9,10]:
        mask = ma.masked_values(array, value)
    #read bands
    bands = []
